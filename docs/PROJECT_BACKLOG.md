...
最后更新：2026-07-13，iter04 closeout。
...
| P2 | SQLite schema migration/version | iter03 follow-up | Planned | 显式记录 schema 版本和可重复升级路径 | Future |
...
| P2 | Agent 严格 wall-clock deadline | iter04 安全复核 | Planned | 将每次 provider timeout 限制为剩余预算，避免在途请求让 90 秒软上限延长 | Future |
